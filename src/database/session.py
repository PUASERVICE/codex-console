...
class DatabaseSessionManager:
    ...
    def migrate_tables(self):
        ...
        migrations = [
            ...
            ("registration_tasks", "phase", "VARCHAR(50)"),
            ("registration_tasks", "reason_code", "VARCHAR(50)"),
            ("registration_tasks", "defer_bucket", "VARCHAR(30)"),
            ("registration_tasks", "retry_count", "INTEGER DEFAULT 0"),
            ("registration_tasks", "next_retry_at", "DATETIME"),
            ("registration_tasks", "context_version", "INTEGER DEFAULT 0"),
